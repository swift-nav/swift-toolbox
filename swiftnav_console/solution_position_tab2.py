...
class SolutionPositionPoints2(QObject):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
...
class SolutionPositionModel2(QObject):  # pylint: disable=too-few-public-methods
    @Slot(SolutionPositionPoints2)  # type: ignore
    def fill_console_points(self, cp: SolutionPositionPoints2) -> SolutionPositionPoints2:  # pylint:disable=no-self-use
