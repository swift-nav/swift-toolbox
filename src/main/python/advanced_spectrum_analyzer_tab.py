...
from PySide2.QtCore import Property, QLine, QObject, QPointF, Slot
...
class AdvancedSpectrumAnalyzerModel(QObject):  # pylint: disable=too-few-public-methods
    ...
    def fill_console_points(self, cp: AdvancedSpectrumAnalyzerPoints) -> AdvancedSpectrumAnalyzerPoints:  # pylint:disable=no-self-use
