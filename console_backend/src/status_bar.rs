...
use crate::types::{IPC_KIND_CAPNP, ArcBool, BaselineNED, IpcSender, GnssModes, PosLLH, SharedState};
...
#[derive(Debug)]
pub struct StatusBar<S: IpcSender> {
    client_sender: S,
...
impl<S: IpcSender> Drop for StatusBar<S> {
    fn drop(&mut self) {
