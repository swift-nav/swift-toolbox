...
class FusionEngineStatusBar(QObject):
...
class FusionEngineStatusBarModel(QObject):  # pylint: disable=too-few-public-methods
    @Slot(FusionEngineStatusBar)  # type: ignore
    def fill_console_points(self, cp: FusionEngineStatusBar) -> FusionEngineStatusBar:  # pylint:disable=no-self-use
